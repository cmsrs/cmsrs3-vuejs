...
describe("functions", () => {
  const errStrOrJsonTest1 = {
    "title.pl": ["The title.pl field is required."],
    "short_title.pl": ["The short title.pl field is required."],
    "title.en": ["The title.en field is required."],
    "short_title.en": ["The short title.en field is required."],
  };
...
describe("retrieveParamsFromStorage", () => {
  ...
  it("get all params", async () => {
    const { configLangs, configDefaultLang, pageTypes, cacheEnable, token } =
