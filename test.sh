...
#./node_modules/jest/bin/jest.js  --verbose -t "stores authorization header value in storage" src/pages/LoginPage.spec.js
#./node_modules/jest/bin/jest.js  --verbose -t "stores config in storage" src/pages/LoginPage.spec.js
